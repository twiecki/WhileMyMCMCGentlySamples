...
Regardless of what metaphor, definition, or label you apply to this class of researcher, it is clear that their skill set is highly valuable in both academia and industry: the Brain Drain comes from the unfortunate fact that academia fails to properly reward the valuable skill set of the data scientist.
...
4. Recognizing that not all students will end up in academia, how do we best prepare them for success both inside and outside academia?
...
- Stability: before finding a permanent position, it is common now for young scientists to do several postdocs, each perhaps in a different part of the country. This means many are unable to become rooted in a community until their mid-30s or later. For an industry data scientist, on the other hand, there may be many permanent job options near home.
...
#### From the outside:
- Publishers might provide a means of publishing code as a primary research project. Introducing a DOI for code, for example, might lead to increased citation and recognition of alternative academic metrics.
- Publishers might push for reproducibility as a requirement for publication. Reproducibility of data-intensive research requires the well-engineered code that data scientists can produce.
...
- University leadership might create joint positions: e.g. paying half of a professor or researcher's salary so that they can focus time on tasks such as creating software tools.
- Department leadership might take the lead to adapt their curriculum to include data science topics, and specifically hire tenure-track faculty who have a data science emphasis.
...
Fortunately, these marketable skills are the same skills that can lead to success in modern data-intensive scientific research: the ability to design and write good software, to write tools that others can reuse, to effectively work with large datasets, etc.
Unfortunately, development of this skill set takes time and energy both at the level of graduate course requirements, and at the level of research time.
...
This is hacking not in the hollywood sense of using computers for malicious purposes, but hacking in the sense of working within a rigid system to accomplish something it's not necessarily designed to do.
In a sense, this is the best description of what we're after: to find shortcuts that will mold academic scientific research into a more effective version of itself.
...
As I mentioned, my co-conspirator in leading this session was Chris Mentzel, whom I know through his involvement with the recent [Moore-Sloan Data Science Initiative](http://www.moore.org/programs/science/data-driven-discovery/data-science-environments).
For years within his role in the Moore Foundation, Chris has been thinking about these issues from the perspective of a funder of scientific research. His efforts in this area have recently culminated in this $\$$38 million initiative.
The Moore-Sloan Data Science Initiative is a multi-institution, five-year grant to three institutions: University of Washington, University of California Berkeley, and New York University.
One of the primary goals of the grant is to jump-start new career paths for data scientists in scientific domain fields, and each of the three universities has a team who is approaching the work in their own way.

In January, I was hired by UW's [eScience Institute](http://escience.washington.edu/) to help lead the UW portion of this effort. We're in the middle of building a data science studio space that will be a central hub for data-intensive research on campus, and are currently in the process of hiring our first round of interdisciplinary postdocs, data scientists and research scientists. These positions are designed especially to attract those skilled "Pi-shaped" researchers who may fall through the cracks in classic academic tracks, and we place particular value on alternative metrics such as open source contributions and efforts toward reproducibility. Berkeley and NYU are undertaking similar efforts on their own campuses with the [Berkeley Institute for Data Science](http://vcresearch.berkeley.edu/datascience/bids) and NYU's [Center for Data Science](http://cds.nyu.edu/).

### NSF: the IGERT program
The NSF has recently announced its Interactive Graduate Education and Research Traineeship (IGERT) program, which provides funding for interdisciplinary training for PhDs. UW was recently awarded an [IGERT grant](http://escience.washington.edu/education/IGERT/overview), and the first group of interdisciplinary data-focused PhDs will be starting this fall. An important piece of this was that home departments agreed to allow these students to forego some of their normal degree requirements to make room for joint courses on data science skills and techniques. IGERT is an active program, and has interdisciplinary grants to schools and departments around the country.
...
Alyssa Goodman of Harvard was part of our discussion, and mentioned that nearly a decade ago Harvard foresaw began addressing the need for data-intensive science and research. They created a short-lived Initiative for Advanced Computing, which was truncated by the global financial crisis before it could get off the ground.
After that false start, Alyssa and others at Harvard are seeking ways to re-build the momentum they had and address these issues.

### Michigan State: Applied Computational Systems
Another active participant in the discussion was Steve Hsu, Vice President for Research at Michigan State University. He shared some exciting news about a new initiative at Michigan State: the creation of a new *Applied Computational Systems* department. According to Dr. Hsu, they will soon be hiring around 20 interdisciplinary tenure-track faculty, who will have one foot in their home department and one foot in the new ACS department. MSU already has many impressive researchers working in this area: with this effort I'm excited to see the dynamic community they will build.
...
While the lure of a well-funded tech industry will still cause a steady stream of researchers to move away from their academic research, I'm heartened to see so much specific effort to carve-out good niches for the type of researchers equipped to be successful in a world of research driven by ever-growing datasets.